...
<div class="container">
    ...
    <button type="button" class="btn btn-outline-dark">Machine Learning</button>
    <button type="button" class="btn btn-outline-dark">Deep Learning</button>
    <button type="button" class="btn btn-outline-dark">PMP</button>
    <button type="button" class="btn btn-outline-dark">Artificial Intelligence</button>
